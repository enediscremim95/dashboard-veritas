"""
Dentuga Dashboard — geração + deploy automático.
Roda: python generate_dentuga.py

Clínica Dentária · Portugal
Conversão: lead customizado (pixel offsite_conversion.custom)
Moeda: EUR (€)
"""
...
#  CONFIG
# ══════════════════════════════════════════════════════════════════════
CLIENTE_NOME  = "Dentuga"
CLIENTE_SUB   = "Clinica Dentaria · Portugal"
CF_SUBFOLDER  = "dentuga"

HAS_GOOGLE    = False
HAS_ROAS      = False

META_ACT      = "act_896581849981278"
CLIENTE_SLUG  = "Dentuga"

CONV_ACTION   = "lead_formulário_obrigado"
CONV_LABEL    = "Leads"
CONV_UNIT     = "formularios preenchidos"
...
_WINDSOR_CONV = {
    ...
    "lead_formulário_obrigado":  "actions_lead_formulário_obrigado",
}
